...
export default function RightDrawer() {
  ...
  const validationSchema = Yup.object({
    isbn13: Yup.string().length(13, 'ISBN-13 must be exactly 13 characters long').required('ISBN-13 is required'),
    authors: Yup.string().required('Authors are required'),
    publication_year: Yup.number().required('Publication Year is required').typeError('Must be a number'),
  ...
  const handleSubmit = async (values: any, { resetForm }: any) => {
    try {
      const defaultSmallImageUrl = 'https://s.gr-assets.com/assets/nophoto/book/111x148-bcc042a9c91a29c1d680899eff700a03.png';
  ...
  return (
    <>
      ...
      >
        <Button variant="contained" onClick={() => setIsOpen(!isOpen)} sx={{ borderRadius: '0 4px 4px 0' }}>
